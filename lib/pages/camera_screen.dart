...
class CameraScreen extends StatefulWidget {
  ...
  void uploadImage(File file, String path, BuildContext context) {}
}

class _CameraScreenState extends State<CameraScreen> {
  late CameraController controller = CameraController(
    const CameraDescription(name: 'camera', lensDirection: CameraLensDirection.front, sensorOrientation: 90),
